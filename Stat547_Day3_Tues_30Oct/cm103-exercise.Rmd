...
```{r}
# vectorization
commute <- c(60, 40, 20, 35, 15)
person <- c("Parveen", "Leo", "Shawn", "Emmotions","Sarafa")
...
# method 1
f <- function(w)   w[[1]]
map_chr(wesanderson,f)

# method 2
map_chr(wesanderson,head,n=1)

map(wesanderson,head,n=1)  # creates a list
...
map_dfr(got_chars,`[`,desired_info) %>% head()
```
