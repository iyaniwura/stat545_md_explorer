...
Let us view one of the data we just read.
...
``` r
(lotr_unitdy <- bind_rows(lotr1,lotr2,lotr3))
```
...
``` r
lotr_unitdy %>%
      gather(key="Gender", value= "word", contains("ALE"))
```
...
``` r
do.call(bind_rows,lotr_list)   # Base R function
```
...
```
    ...
    ##    <chr>                      <chr>  <int>   <dbl>   <dbl>
    ##  1 The Fellowship Of The Ring Elf      971  NA       1.08 
    ##  2 The Fellowship Of The Ring Elf     1229   0.269  NA    
    ##  3 The Fellowship Of The Ring Hobbit    14  -0.797  NA    
    ##  4 The Fellowship Of The Ring Hobbit  3644  NA      -1.44 
    ##  5 The Fellowship Of The Ring Man        0   0.583  NA    
    ##  6 The Fellowship Of The Ring Man     1995  NA       0.411
    ##  7 The Return Of The King     Elf      183  -0.166  NA    
    ##  8 The Return Of The King     Elf      510  NA       0.744
    ##  9 The Return Of The King     Hobbit     2  -0.693  NA    
    ## 10 The Return Of The King     Hobbit  2673  NA       0.619
    ## 11 The Return Of The King     Man      268  -0.485  NA    
    ## 12 The Return Of The King     Man     2459  NA       0.412
    ## 13 The Two Towers             Elf      331   0.262  NA    
    ## 14 The Two Towers             Elf      513  NA      -0.292
    ## 15 The Two Towers             Hobbit     0  -0.902  NA    
    ## 16 The Two Towers             Hobbit  2463  NA       0.891
    ## 17 The Two Towers             Man      401   1.54   NA    
    ## 18 The Two Towers             Man     3589  NA      -0.524
...
```
    ...
    ##   <chr>  <chr> <dbl>        <dbl>        <dbl>
    ## 1 Alex   a         1       0.644         0.624
    ## 2 Alex   a         2       0.835         0.147
    ## 3 Alex   a         3       0.233         0.641
    ## 4 Robert b         1       0.118         0.321
    ## 5 Robert b         2       0.0627        0.721
    ## 6 Sam    a         1       0.869         0.214
